...
_AUTH_SAFE_PATHS = ("/health", "/webhook", "/whatsapp/webhook", "/", "/api/chatbot", "/api/v1", "/pos", "/api/v1/store/pos/purchases", "/api/v1/store/pos/products", "/api/v1/store/products", "/api/v1/store/sales", "/api/v1/store/purchases")
